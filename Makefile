#############################################################################
# Makefile for building: neverncoin-qt
# Generated by qmake (2.01a) (Qt 4.8.7) on: Sun Jan 3 18:29:55 2021
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -lminiupnpc /root/Desktop/neverncoin/src/leveldb/libleveldb.a /root/Desktop/neverncoin/src/leveldb/libmemenv.a -lrt -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lpthread -lQtGui -lQtNetwork -lQtCore 
AR            = ar cqs
RANLIB        = 
...
/root/Desktop/neverncoin/src/leveldb/libleveldb.a: FORCE
	cd /root/Desktop/neverncoin/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a

/root/Desktop/neverncoin/build/build.h: FORCE
	cd /root/Desktop/neverncoin; /bin/sh share/genbuild.sh /root/Desktop/neverncoin/build/build.h
